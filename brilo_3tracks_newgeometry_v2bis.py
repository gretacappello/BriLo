...
#python brilo_3tracks_newgeometry_v2bis.py
...
for ray in range(1, 11):
    data_type = 'L3'
    path = f'/Users/gretacappello/Desktop/PROJECT_2_METIS_TS/PSI_simulation_erika/plots/L3_data_product/ray{ray}_*.fits'
    path_figures = f'/Users/gretacappello/Desktop/PROJECT_2_METIS_TS/PSI_simulation_erika/plots/L3_tests/ray{ray}/'
...
#for ray in range(2, 11):   #range(2, 11): 
    #data_type = 'LX'
    #path = f'/Users/gretacappello/Desktop/PROJECT_2_METIS_TS/PSI_simulation_erika/plots/LX_data_product/ray{ray}*.fits'
    #path_figures = f'/Users/gretacappello/Desktop/PROJECT_2_METIS_TS/PSI_simulation_erika/plots/LX_tests/ray{ray}/'
    ...
    for example in range(1, 4):  # range goes from 1 to 3  (1, 4)
        ...
        #coordinates = open('/Users/gretacappello/Desktop/PROJECT_2_METIS_TS/23_24_06_2023/comparison_paulett_method/example_'+str(example)+'_line.txt','r')
        ...
        # Central angle (spherical law of cosines)
